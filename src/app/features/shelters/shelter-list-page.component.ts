  ...
  template: `
    <div class="page">
      <div class="page-header">
        <h1 class="page-title">Shelters</h1>
        <button class="btn-primary">Add Shelter</button>
      </div>
      <p class="empty-state">No shelter partners yet.</p>
    </div>
  `,
  styles: [`
...
export class ShelterListPageComponent {}
